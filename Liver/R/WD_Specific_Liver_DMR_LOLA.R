# WD Liver Enrichment Analysis
# WD Specific DMRs
# LOLA Core, Extended, ChromHMM, ENCODE Liver ChipSeq
# Charles Mordaunt
# 1/3/18
...
# Load Data ####
index <- read.delim(file = "Tables/LOLA Roadmap ChromHMM index.txt", sep = "\t", header = TRUE)
stats <- read.delim(file = "Tables/WD_Specific_DMRs_All_Hyper_Hypo_LOLA.tsv", sep = "\t", header = TRUE)
...
table(chromhmm_all$support < 5) # 159 region sets 
...
write.table(x = chromhmm_all, file = "Tables/WD_Liver_Specific_DMRs_All_ChromHMM_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(roadmap_all$support < 5) # 15 region sets 
...
write.table(x = roadmap_all, file = "Tables/WD_Liver_Specific_DMRs_all_Roadmap_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(liver_TFs_all$support < 5) # 0 region sets 
...
write.table(x = liver_TFs_all, file = "Tables/WD_Liver_Specific_DMRs_all_LOLA_Liver_TF_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
gg +
        ...
        scale_fill_gradientn("-logOR\n", colors = c("Black", "#FF0000"), values = c(0,1), na.value = "#FF0000", limits=c(0,33)) +
...
ggsave("Figures/LOLA WD Specific DMR ChromHMM logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")

# logFDR Heatmap
gg <- ggplot(data = chromhmm_all)
gg +
        geom_tile(aes(x = chromState, y = order, fill = qValueLog)) +
        scale_fill_gradientn("-logFDR\n", colors = c("Black", "#FF0000"), values = c(0,1), na.value = "#FF0000", limits=c(0,405)) +
        theme_bw(base_size = 24) +
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              axis.ticks.x = element_line(size = 1.25), legend.key = element_blank(), 
              panel.grid.minor = element_blank(), legend.position = c(1.2, 0.84), 
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR ChromHMM logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR ChromHMM legend by tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
ggsave("Figures/LOLA WD Specific DMR and Background ChromHMM Mean Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        scale_y_continuous(expand=c(0,0), breaks = c(0, 25, 50, 75, 100)) +
        scale_x_discrete(expand = c(0,0))
ggsave("Figures/LOLA WD Specific DMR and Background ChromHMM Liver Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        scale_fill_gradientn("-logOR\n", colors = c("Black", "#FF0000"), values = c(0,1), na.value = "#FF0000", limits=c(0,29)) +
        theme_bw(base_size = 24) +
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              axis.ticks.x = element_line(size = 1.25), legend.key = element_blank(), 
              panel.grid.minor = element_blank(), legend.position = c(1.2, 0.84), 
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_all logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")

# logFDR Heatmap
gg <- ggplot(data = roadmap_all)
gg +
        geom_tile(aes(x = antibody, y = order, fill = qValueLog)) +
        scale_fill_gradientn("-logFDR\n", colors = c("Black", "#FF0000"), values = c(0,1), na.value = "#FF0000", limits=c(0,477)) +
        theme_bw(base_size = 24) +
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              axis.ticks.x = element_line(size = 1.25), legend.key = element_blank(), 
              panel.grid.minor = element_blank(), legend.position = c(1.2, 0.84), 
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_all logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_all legend by tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        geom_text(data=top, aes(x=logOddsRatio, y=qValueLog, label=antibody), 
                  size=4, check_overlap = TRUE, hjust=0, nudge_x=0.2, nudge_y=0) +
        annotate("text", label="RXRA", x=8.28, y=253.2, size=4) +
        theme_bw(base_size = 24) +
...
ggsave("Figures/LOLA WD Specific DMR Liver TF Volcano Plot.png", dpi = 600, width = 7, height = 5, units = "in")
...
table(chromhmm_hyper$support < 5) # 245 region sets 
...
write.table(x = chromhmm_hyper, file = "Tables/WD_Liver_Specific_DMRs_Hyper_ChromHMM_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(roadmap_hyper$support < 5) # 28 region sets 
...
write.table(x = roadmap_hyper, file = "Tables/WD_Liver_Specific_DMRs_hyper_Roadmap_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(liver_TFs_hyper$support < 5) # 0 region sets 
...
table(is.infinite(liver_TFs_hyper$pValueLog)) # 2 True ##
...
table(is.infinite(liver_TFs_hyper$qValueLog)) # 2 True
...
write.table(x = liver_TFs_hyper, file = "Tables/WD_Liver_Specific_DMRs_hyper_LOLA_Liver_TF_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific Hyper DMR ChromHMM logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific Hyper DMR ChromHMM logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        scale_y_continuous(expand=c(0,0), breaks = c(0, 25, 50, 75, 100)) +
        scale_x_discrete(expand = c(0,0))
ggsave("Figures/LOLA WD Specific Hyper DMR and Background ChromHMM Mean Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        scale_y_continuous(expand=c(0,0), breaks = c(0, 25, 50, 75, 100)) +
        scale_x_discrete(expand = c(0,0))
ggsave("Figures/LOLA WD Specific Hyper DMR and Background ChromHMM Liver Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_hyper logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_hyper logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
ggsave("Figures/LOLA WD Specific Hyper DMR Liver TF Volcano Plot.png", dpi = 600, width = 7, height = 5, units = "in")
...
table(chromhmm_hypo$support < 5) # 256 region sets 
...
write.table(x = chromhmm_hypo, file = "Tables/WD_Liver_Specific_DMRs_Hypo_ChromHMM_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(roadmap_hypo$support < 5) # 43 region sets 
...
write.table(x = roadmap_hypo, file = "Tables/WD_Liver_Specific_DMRs_hypo_Roadmap_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
table(liver_TFs_hypo$support < 5) # 3 region sets 
...
write.table(x = liver_TFs_hypo, file = "Tables/WD_Liver_Specific_DMRs_hypo_LOLA_Liver_TF_Enrichment.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific Hypo DMR ChromHMM logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific Hypo DMR ChromHMM logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        scale_y_continuous(expand=c(0,0), breaks = c(0, 25, 50, 75, 100)) +
        scale_x_discrete(expand = c(0,0))
ggsave("Figures/LOLA WD Specific Hypo DMR and Background ChromHMM Mean Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        scale_y_continuous(expand=c(0,0), breaks = c(0, 25, 50, 75, 100)) +
        scale_x_discrete(expand = c(0,0))
ggsave("Figures/LOLA WD Specific Hypo DMR and Background ChromHMM Liver Percent chromState.png", dpi = 600, width = 6, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_hypo logOR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR roadmap_hypo logFDR by Tissue.png", dpi = 600, width = 5, height = 7, units = "in")
...
ggsave("Figures/LOLA WD Specific Hypo DMR Liver TF Volcano Plot.png", dpi = 600, width = 7, height = 5, units = "in")

# Max values for scales ####
# Round up
# logOR
max(roadmap_all$logOddsRatio, roadmap_hyper$logOddsRatio, roadmap_hypo$logOddsRatio) #29
max(chromhmm_all$logOddsRatio, chromhmm_hyper$logOddsRatio, chromhmm_hypo$logOddsRatio) #33

# FDR
max(roadmap_all$qValueLog, roadmap_hyper$qValueLog, roadmap_hypo$qValueLog) #477
max(chromhmm_all$qValueLog, chromhmm_hyper$qValueLog, chromhmm_hypo$qValueLog) #405
...
gg +
        ...
        geom_text(data=top, aes(x=hyper_logOddsRatio, y=hypo_logOddsRatio, label=antibody), 
                  size=3.5, check_overlap = TRUE, hjust=0, nudge_x=0.3, nudge_y=0) +
...
ggsave("Figures/LOLA WD Specific Hyper vs Hypo DMR liver TF logOR Volcano Plot.png", dpi = 600, width = 7, height = 5, units = "in")
...
gg +
        ...
        geom_text(data=top, aes(x=hyper_qValueLog, y=hypo_qValueLog, label=antibody), 
                  size=3.5, check_overlap = TRUE, hjust=0, nudge_x=5, nudge_y=0) +
        ...
        scale_x_continuous(breaks=pretty_breaks(n=5)) +
        scale_y_continuous(breaks=pretty_breaks(n=5)) +
        coord_cartesian(xlim=c(0,375), ylim=c(0,375))
ggsave("Figures/LOLA WD Specific Hyper vs Hypo DMR liver TF logFDR Volcano Plot.png", dpi = 600, width = 7, height = 5, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR Liver TF OR Heatmap.png", dpi = 600, width = 5, height = 7, units = "in")
...
gg +
        ...
        theme(panel.grid.major = element_blank(), panel.border = element_rect(color = "black", size = 1.25),
              ...
              legend.title = element_text(size = 18),
              plot.title = element_text(size = 18))
ggsave("Figures/LOLA WD Specific DMR Liver TF FDR Heatmap.png", dpi = 600, width = 5, height = 7, units = "in")

# Enriched Liver TFs ####
liver_TFs_all_enriched <- subset(liver_TFs_all, logOddsRatio > 8 & qValueLog > 128) # Thresholds are Q3 for all DMRs, rounded up
# HNF4A RXRA  HNF4G
liver_TFs_hyper_enriched <- subset(liver_TFs_hyper, logOddsRatio > 8 & qValueLog > 128)
# HNF4A RXRA  MAX   RAD21 HNF4G REST  JUND  FOXA2
liver_TFs_hypo_enriched <- subset(liver_TFs_hypo, logOddsRatio > 8 & qValueLog > 128)
# None
